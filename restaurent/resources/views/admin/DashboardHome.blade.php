            ...
            <div class="main-content">
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-md-3 col-6">
                        <div class="card bg-primary border-primary text-white overflow-hidden" data-bs-toggle="collapse"
                            data-bs-target="#totalHACCP">
                            <div class="card-body ">
                    ...
                    <div class="col-xxl-3 col-md-3 col-6">
                        <div class="card bg-success border-success text-white overflow-hidden" data-bs-toggle="collapse"
                            data-bs-target="#totalSQF">
                            <div class="card-body">
                    ...
                    <div class="col-xxl-3 col-md-3 col-6">
                        <div class="card bg-warning border-warning text-white overflow-hidden" data-bs-toggle="collapse"
                            data-bs-target="#totalVendorActivity">
                            <div class="card-body">
                                <i class="feather-folder-minus fs-1"></i>
                                <h5 class="fs-4 text-reset mt-4 mb-1">2,245</h5>
                                <div class="fs-12 text-reset fw-normal">Total Vendor Avtivities</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-md-3 col-6">
                        <div class="card bg-danger border-danger text-white overflow-hidden" data-bs-toggle="collapse"
                            data-bs-target="#totalUsers">
                            <div class="card-body">
                                ...
                                <div class="card bg-soft-primary  border-soft-primary text-primary overflow-hidden">
                                    <a href="HACCP-01.html" class="text-decoration-none">
                                        <div class="card-body justify-content-center text-center">
                                            <h5 class="text-reset text-primary">8,475</h5>
                            ...
                            <div class="col-xxl-3 col-md-3 col-6">
                                <div class="card bg-soft-success border-soft-success text-success overflow-hidden">
                                    <a href="javascript:void(0);" class="text-decoration-none">
                                        <div class="card-body justify-content-center text-center">
                                            <h5 class="text-reset text-success">8,475</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-md-3 col-6">
                                <div class="card bg-soft-warning border-soft-warning text-warning overflow-hidden">
                                    <a href="javascript:void(0);" class="text-decoration-none">
                                        <div class="card-body justify-content-center text-center">
                                            <h5 class="text-reset text-warning">8,475</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-md-3 col-6">
                                <div class="card bg-soft-danger border-soft-danger text-danger overflow-hidden">
                                    <a href="javascript:void(0);" class="text-decoration-none">
                                        <div class="card-body justify-content-center text-center">
                                            <h5 class="text-reset text-danger">8,475</h5>
                                                ...
                                                <td class="project-name-td">
                                                    <div class="hstack gap-4">
                                                        <div class="avatar-image border-0">
                                                            <img src="dashboard-penal/assets/images/brand/app-store.png" alt=""
                                                                class="img-fluid" />
                                                        </div>
                                                        <div>
                                                            <a href="projects-view.html"
                                                                class="text-truncate-1-line">Oscar Smith</a>
                                                            <p
